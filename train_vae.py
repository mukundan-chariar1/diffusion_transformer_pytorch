...
def train_GAN(
    ...
    tracker = VAEGAN_Tracker(n_iters, plot_freq)  # ✅ Updated to VAEGAN_Tracker
    ...
    while iter < n_iters:
        for x_real in train_loader:
            ...
            with torch.no_grad():
                ...
                z_sample = torch.randn(24, *generator.latent_size, device=device)
                gen_samples = generator.decode(z_sample)

                # Pick a random sample for reconstruction visualization
